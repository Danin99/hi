        ...
        <div class="pt-14 pb-8">
            <div class="gap-4">
                ...
                <div class="pt-6 mb-5 rounded-md flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-[#1c2441]">Edit Admin</h1>
                    <nav class="font-normal">
                        <a href="{{ route('admin.dashboard') }}" class="text-gray-500">Dashboard /</a>
                        <a href="{{ route('admin.roles.index') }}" class="text-gray-500">Admin /</a>
                        <span class="text-blue-500">Edit</span>
                    </nav>
                </div>

                <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" class="bg-white p-6 border">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="username" name="username"
                                ...
                                placeholder="Enter User" required value="{{ $admin->username }}" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-[8px] px-3"
                                placeholder="Enter Name" value="{{ $admin->email }}" required />
                        </div>
                        <div>
                    ...
                    <div class="flex gap-2 mt-5">
                        ...
                        <button type="submit"
                            class="flex gap-3 items-center px-5 py-3 justify-center text-white bg-green-500 hover:bg-green-400 focus:ring-4 focus:ring-primary-300 font-medium rounded-sm text-sm focus:outline-none">Update</button>
                    </div>
                </form>
