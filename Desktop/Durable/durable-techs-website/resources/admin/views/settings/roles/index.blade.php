            ...
            <div class="gap-4">
                ...
                <div class="bg-white relative border overflow-hidden">
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" value="{{ request()->input('query_keyword') }}"
                                        name="search_keyword"
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.roles.index') }}" type="button"
                                class="flex items-center h-[43px] w-[43px] justify-center text-white bg-[#3c50e0] bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-sm text-sm focus:outline-none">
                    ...
                    <div class="overflow-x-auto">
                        @include('admin::settings.roles.table')
                    </div>
                </div>
