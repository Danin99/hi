<div id="hideShowModal-{{ $item->id }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="hideShowModal-{{ $item->id }}">
            ...
            <form class="p-4 md:p-5 text-center"
                action="{{ route('admin.' . $target . '.hide-show', ['type' => "{$type}", 'id' => $item->id]) }}"
                method="POST">
                ...
                <button data-modal-hide="hideShowModal-{{ $item->id }}" type="button"
